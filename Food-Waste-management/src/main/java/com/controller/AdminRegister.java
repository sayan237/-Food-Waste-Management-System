...
public class AdminRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
              ...
              Connection connection1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/food?useSSL=false", "root", "DB_PASSWORD_PLACEHOLDER");
              

            // Prepare the SQL query
            String sql = "INSERT INTO admin (name, username, email, password_hash, password_salt, phone) VALUES (?, ?, ?, ?, ?, ?)";
           ...
           pstm .setString(2, username);
            ...
            pstm.setString(4, hashedPassword);  // Store the hashed password
            pstm.setString(5, salt);  // Store the salt
