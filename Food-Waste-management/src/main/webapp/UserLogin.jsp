...
<script>
        ...
        function showAlert(status) {
            if (status === "failedpass") {
            	...
            	Swal.fire("Sorry", "Invalid Username!", "error");
            }
            	...
            	Swal.fire("Sorry", "Unexpected error!", "error");
            }
        }
    </script>
			...
			<div class="container">
				<div class="signin-content">
					<div class="signin-image">
						...
						<a href="UserRegister.jsp" class="signup-image-link">Create an
							account</a>
					</div>

					<div class="signin-form">
						<h2 class="form-title">Sign In</h2>
						<form method="post" action="UserLoginController" class="register-form"
							id="login-form">
